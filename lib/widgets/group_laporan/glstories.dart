...
class StoriesGL extends StatelessWidget {
  final User currentUser;
  final List<StoryGL> stories;
    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          final StoryGL story = stories[index];
          return Padding(
            padding: const EdgeInsets.symmetric(horizontal: 4.0),
            child: _StoryCardGL(story: story),
          );
        },
      ),
    );
...
class _StoryCardGL extends StatelessWidget {
