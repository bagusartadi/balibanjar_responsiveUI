...
class PostContainerGU extends StatelessWidget {
  final PostGU post;

  const PostContainerGU({
    Key key,
    @required this.post,
  }) : super(key: key);
...
class _PostHeaderGU extends StatelessWidget {
  final PostGU post;
...
class _PostStatsGU extends StatelessWidget {
  final PostGU post;
