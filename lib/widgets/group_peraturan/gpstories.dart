...
class StoriesGP extends StatelessWidget {
  final User currentUser;
  final List<StoryGP> stories;
    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          final StoryGP story = stories[index];
          return Padding(
            padding: const EdgeInsets.symmetric(horizontal: 4.0),
            child: _StoryCardGP(story: story),
          );
        },
      ),
    );
...
class _StoryCardGP extends StatelessWidget {
